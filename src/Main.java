...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            if (board.isCheck()) {
                if (board.isMate() && !board.canSafeKing()) {
                    System.out.println("Королю " + board.nowPlayer + " поставлен мат. Игра окончена.");
                    break;
                }

                System.out.println("Королю " + board.nowPlayer + " поставлен шах. Защищайтесь");
            }
